...
class _RestaurantRepo implements RestaurantRepo {
  ...
  @override
  Future<CursorPagination<RestaurantModel>> paginate({paginationParams = const PaginationParams()}) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<CursorPagination<RestaurantModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
